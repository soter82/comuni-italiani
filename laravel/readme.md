...
4. Modicare il contenuto del file del modello per poter aggiungere massivamente i dati nella tabella. Inoltre bisogna specificare che la chiave primaria della tabella è una stringa
